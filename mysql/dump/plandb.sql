...
-- Дамп данных таблицы plandb.core_store: ~6 rows (приблизительно)
...
INSERT INTO `employees` (`id`, `name`, `surname`, `patronymic`, `phone`, `comment`, `passport`, `foreign_passport`, `location`, `created_by`, `updated_by`, `created_at`, `updated_at`, `employee_role`) VALUES
	...
	(19, 'Сергей', 'Домнышев', 'Михайлович', '+7 916 233-62-89', NULL, NULL, NULL, 1, 1, 1, '2021-06-23 12:49:51', '2021-08-04 11:46:43', 5),
...
-- Дамп данных таблицы plandb.logs: ~0 rows (приблизительно)
...
INSERT INTO `strapi_permission` (`id`, `action`, `subject`, `properties`, `conditions`, `role`, `created_at`, `updated_at`) VALUES
	...
	(1548, 'plugins::content-manager.explorer.delete', 'application::employee.employee', '{}', '[]', 1, '2021-08-04 09:57:51', '2021-08-04 09:57:51'),
	(1549, 'plugins::content-manager.explorer.delete', 'application::employee-role.employee-role', '{}', '[]', 1, '2021-08-04 09:57:51', '2021-08-04 09:57:51'),
	(1550, 'plugins::content-manager.explorer.delete', 'application::location.location', '{}', '[]', 1, '2021-08-04 09:57:51', '2021-08-04 09:57:51'),
	(1551, 'plugins::content-manager.explorer.delete', 'application::metatheme-aether-plan.metatheme-aether-plan', '{}', '[]', 1, '2021-08-04 09:57:51', '2021-08-04 09:57:51'),
	(1552, 'plugins::content-manager.explorer.delete', 'application::log.log', '{}', '[]', 1, '2021-08-04 09:57:51', '2021-08-04 09:57:51'),
	(1553, 'plugins::content-manager.explorer.delete', 'application::metatheme-inclusion.metatheme-inclusion', '{}', '[]', 1, '2021-08-04 09:57:51', '2021-08-04 09:57:51'),
	(1554, 'plugins::content-manager.explorer.delete', 'application::metatheme-aether.metatheme-aether', '{}', '[]', 1, '2021-08-04 09:57:51', '2021-08-04 09:57:51'),
	(1555, 'plugins::content-manager.explorer.delete', 'application::metatheme-section.metatheme-section', '{}', '[]', 1, '2021-08-04 09:57:51', '2021-08-04 09:57:51'),
	(1556, 'plugins::content-manager.explorer.delete', 'application::metatheme.metatheme', '{}', '[]', 1, '2021-08-04 09:57:51', '2021-08-04 09:57:51'),
	(1557, 'plugins::content-manager.explorer.delete', 'application::shooting.shooting', '{}', '[]', 1, '2021-08-04 09:57:51', '2021-08-04 09:57:51'),
	(1558, 'plugins::content-manager.explorer.delete', 'application::syslog.syslog', '{}', '[]', 1, '2021-08-04 09:57:52', '2021-08-04 09:57:52'),
	(1559, 'plugins::content-manager.explorer.delete', 'application::tech-resource-status.tech-resource-status', '{}', '[]', 1, '2021-08-04 09:57:52', '2021-08-04 09:57:52'),
	(1560, 'plugins::content-manager.explorer.delete', 'application::tech-resource.tech-resource', '{}', '[]', 1, '2021-08-04 09:57:52', '2021-08-04 09:57:52'),
	(1561, 'plugins::content-manager.explorer.delete', 'plugins::users-permissions.user', '{}', '[]', 1, '2021-08-04 09:57:52', '2021-08-04 09:57:52'),
	(1562, 'plugins::content-manager.explorer.publish', 'application::metatheme.metatheme', '{}', '[]', 1, '2021-08-04 09:57:52', '2021-08-04 09:57:52'),
	(1563, 'plugins::content-manager.explorer.publish', 'application::tech-resource.tech-resource', '{}', '[]', 1, '2021-08-04 09:57:52', '2021-08-04 09:57:52');
...
CREATE TABLE IF NOT EXISTS `syslogs` (
  ...
  `updated_at` timestamp NULL DEFAULT CURRENT_TIMESTAMP,
  PRIMARY KEY (`id`)
) ENGINE=InnoDB AUTO_INCREMENT=5706 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci;
