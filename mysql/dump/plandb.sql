...
INSERT INTO `metathemes` (`id`, `name`, `date_start`, `date_end`, `short_description`, `description`, `address`, `comment_inclusions`, `comment_aether_plans`, `metatheme_section`, `created_by`, `updated_by`, `created_at`, `updated_at`, `status_coord`, `status_log`, `country`, `comment_coord`, `published_at`, `sortParam`) VALUES
	...
	(2, 'Первые лица, События Тест 2', '2021-08-03 12:00:00', '2021-08-03 14:00:00', 'Краткое описание Первые лица, События Тест 2', 'Полное описание Первые лица, События Тест 2', 'Адрес Первые лица, События Тест 2', 'Комментарий', 'Комментарий', 1, 1, 1, '2021-06-25 09:32:24', '2021-07-30 14:33:23', 'new', 1, NULL, NULL, '2021-06-25 09:32:24', 2),
...
INSERT INTO `strapi_permission` (`id`, `action`, `subject`, `properties`, `conditions`, `role`, `created_at`, `updated_at`) VALUES
	...
	(1309, 'plugins::content-manager.explorer.delete', 'application::metatheme-aether.metatheme-aether', '{}', '[]', 1, '2021-07-30 14:21:44', '2021-07-30 14:21:44'),
	(1310, 'plugins::content-manager.explorer.delete', 'application::metatheme-aether-plan.metatheme-aether-plan', '{}', '[]', 1, '2021-07-30 14:21:44', '2021-07-30 14:21:44'),
	(1311, 'plugins::content-manager.explorer.delete', 'application::location.location', '{}', '[]', 1, '2021-07-30 14:21:44', '2021-07-30 14:21:44'),
	(1312, 'plugins::content-manager.explorer.delete', 'application::employee.employee', '{}', '[]', 1, '2021-07-30 14:21:44', '2021-07-30 14:21:44'),
	(1313, 'plugins::content-manager.explorer.delete', 'application::employee-role.employee-role', '{}', '[]', 1, '2021-07-30 14:21:44', '2021-07-30 14:21:44'),
	(1314, 'plugins::content-manager.explorer.delete', 'application::metatheme-inclusion.metatheme-inclusion', '{}', '[]', 1, '2021-07-30 14:21:44', '2021-07-30 14:21:44'),
	(1315, 'plugins::content-manager.explorer.delete', 'application::metatheme-section.metatheme-section', '{}', '[]', 1, '2021-07-30 14:21:44', '2021-07-30 14:21:44'),
	(1316, 'plugins::content-manager.explorer.delete', 'application::metatheme.metatheme', '{}', '[]', 1, '2021-07-30 14:21:44', '2021-07-30 14:21:44'),
	(1317, 'plugins::content-manager.explorer.delete', 'application::shooting.shooting', '{}', '[]', 1, '2021-07-30 14:21:44', '2021-07-30 14:21:44'),
	(1318, 'plugins::content-manager.explorer.delete', 'application::syslog.syslog', '{}', '[]', 1, '2021-07-30 14:21:44', '2021-07-30 14:21:44'),
	(1319, 'plugins::content-manager.explorer.delete', 'application::tech-resource-status.tech-resource-status', '{}', '[]', 1, '2021-07-30 14:21:44', '2021-07-30 14:21:44'),
	(1320, 'plugins::content-manager.explorer.delete', 'plugins::users-permissions.user', '{}', '[]', 1, '2021-07-30 14:21:44', '2021-07-30 14:21:44'),
	(1321, 'plugins::content-manager.explorer.delete', 'application::tech-resource.tech-resource', '{}', '[]', 1, '2021-07-30 14:21:44', '2021-07-30 14:21:44'),
	(1322, 'plugins::content-manager.explorer.publish', 'application::metatheme.metatheme', '{}', '[]', 1, '2021-07-30 14:21:44', '2021-07-30 14:21:44'),
	(1323, 'plugins::content-manager.explorer.publish', 'application::tech-resource.tech-resource', '{}', '[]', 1, '2021-07-30 14:21:44', '2021-07-30 14:21:44');
...
CREATE TABLE IF NOT EXISTS `syslogs` (
  ...
  `updated_at` timestamp NULL DEFAULT CURRENT_TIMESTAMP,
  PRIMARY KEY (`id`)
) ENGINE=InnoDB AUTO_INCREMENT=3860 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci;
